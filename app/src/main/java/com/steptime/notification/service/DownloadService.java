...
public class DownloadService extends Service {
	 ...
	 * 下载缓存
	 */
	public static final String DOWNLOAD_DIR = Environment.getExternalStorageDirectory().getAbsolutePath() + "/com.steptime/download";
	...
	private String saveFileName = DOWNLOAD_DIR;
